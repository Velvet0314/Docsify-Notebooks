...
//看板娘样式设置
live2d_settings["waifuSize"] = "215x215"; // 看板娘大小，例如 '280x250', '600x535'
live2d_settings["waifuTipsSize"] = "250x65"; // 提示框大小，例如 '250x70', '570x150'
...
live2d_settings["waifuEdgeSide"] = "left:-45"; // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
function initModel(waifuPath, type) {
  ...
  // 添加 toggle
  $("body").append(
    '<div id="waifu-toggle" class="waifu-toggle-active">看板娘</div>'
  );
  $("#waifu-toggle").addClass("waifu-toggle-active");
  $("#waifu-toggle").css("left", "0px");

  $(".waifu").hide(); // 初始状态隐藏看板娘
...
function loadTipsMessage(result) {
  ...
  // 重新显示看板娘的按钮点击事件
  $(document).on("click", "#waifu-toggle", function () {
    $(".waifu")
      .css({
        bottom: "-400px",
      })
