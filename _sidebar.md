...
* [第九章&ensp;EM 算法](note9/Part9.md)
  ...
  * [EM 算法详解](note9/Part9.md?id=EM-算法详解)
  * [高斯混合模型详解](note9/Part9.md?id=高斯混合模型详解)
* [第十章&ensp;因子分析](note10/Part10.md)
  * [<span class="math">$\small{\Sigma}$</span> 的约束条件](note10/Part10.md?id=largesigma-的约束条件)
  * [多重高斯模型的边缘分布与条件分布](note10/Part10.md?id=多重高斯模型的边缘分布与条件分布)
  * [因子分析模型](note10/Part10.md?id=因子分析模型)
  * [适用于因子分析的 EM 算法](note10/Part10.md?id=适用于因子分析的-EM-算法)
